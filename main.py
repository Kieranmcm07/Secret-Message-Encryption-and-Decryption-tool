...
def decryption_key():
    ...
    if key == "1234":
        ...
        Label(screen2, text="DECRYPTION RESULTS", font="Arial", fg="white", bg="#00bd56").place(x=10, y=0)
    ...
    # Handle incorrect or empty key
        ...
        messagebox.showerror("Encryption and Decryption Tool", "Input Password")
    elif key != "1234":
        messagebox.showerror("Encryption and Decryption Tool", "Invalid Password")
...
def encryption_key():
    ...
    if key == "1234":
        ...
        Label(screen1, text="ENCRYPTION RESULTS", font="Arial", fg="white", bg="#ed3833").place(x=10, y=0)
    ...
    # Handle incorrect or empty key
        ...
        messagebox.showerror("Encryption and Decryption Tool", "Please Enter a Password")
    elif key != "1234":
        messagebox.showerror("Encryption and Decryption Tool", "Incorrect Password")
...
def main_display():
    ...
    Button(text="ENCRYPT", height="2", width=23, bg="#ed3833", fg="white", bd=0, command=encryption_key).place(x=10, y=250)
    Button(text="DECRYPT", height="2", width=23, bg="#00bd56", fg="white", bd=0, command=decryption_key).place(x=200, y=250)
